...
export default function SortableCategory({
  ...
  onReorderProducts: (categoryId: string, newProducts: Product[]) => void;
}) {
  ...
  const handleProductDragEnd = (event: any) => {
    ...
    if (over && active.id !== over.id) {
      ...
      onReorderProducts(category.id, newProducts); // ✅
    }
  };
                ...
                <div className="space-y-3">
                  {category.products.map((product) => (
                    <SortableProduct
                      ...
                      onDelete={() =>
                        onDeleteProduct(category.id, product.id)
                      }
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingProduct
                ...
                : "Agrega un nuevo producto a la categoría"}
            </DialogDescription>
          </DialogHeader>
          <ProductForm
